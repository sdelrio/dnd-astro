...
| 014 | FG Effects Page Migration with Mermaid | active | fantasy-grounds, mermaid, migration, starlight, diagrams, fg-effects | `package.json`, `astro.config.mjs`, `src/content/docs/fantasy-grounds/fg-effects.mdx`, `src/content/docs/index.mdx`, `docs/specs/014-fg-effects-migration/` | Faithful port of the golden-forest FG Effects page with its sequence diagram rendered via astro-mermaid |
